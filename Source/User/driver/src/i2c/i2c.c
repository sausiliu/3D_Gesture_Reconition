/******************************************************************************
File    : i2c.c
Purpose : I2c2 to communicate with the sensors
...
#define I2Cx_FLAG_TIMEOUT             ((u32) 900) //0x1100
#define I2Cx_LONG_TIMEOUT             ((u32) (300 * I2Cx_FLAG_TIMEOUT)) //was300
...
/**
  ...
  * @retval None.
  */
static u32 I2Cx_TIMEOUT_UserCallback(char value)
{
...
{
  u32  result = 0;
  u32  i = 0; // i = RegisterLen;
  volatile u32  I2CTimeout = I2Cx_LONG_TIMEOUT;
...
unsigned long ST_Sensors_I2C_ReadRegister(unsigned char Address, unsigned char RegisterAddr, unsigned short RegisterLen, unsigned char *RegisterValue)
{
  ...
  else if( RegisterLen == 2) 
  {
   ...
   /* Set POS bit */ 
   SENSORS_I2C->CR1 |= I2C_PECPosition_Next;
...
endReadLoop:  
  ...
  //Disable POS -- TODO
  SENSORS_I2C->CR1 &= I2C_PECPosition_Current;  
